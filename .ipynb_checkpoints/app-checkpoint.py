 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "2024-05-03 00:20:05.130 \n",
      "  \u001b[33m\u001b[1mWarning:\u001b[0m to view this Streamlit app on a browser, run it with the following\n",
      "  command:\n",
      "\n",
      "    streamlit run C:\\Users\\kardo\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site-packages\\ipykernel_launcher.py [ARGUMENTS]\n"
     ]
    },
    {
     "data": {
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "<>:26: SyntaxWarning: 'int' object is not callable; perhaps you missed a comma?\n",
      "C:\\Users\\kardo\\AppData\\Local\\Temp\\ipykernel_23856\\3625183365.py:26: SyntaxWarning: 'int' object is not callable; perhaps you missed a comma?\n",
   ...
   "source": [
    ...
    "                cv2.putText(frame, emotion_dict[max_index],(x+20,y-60),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255),2,cv2.LINEAR)\n",
